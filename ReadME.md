<table>
  <tr>
    <td width="70%" valign="top">
      ...
      <p style="margin: 0;">
        🔹 Building ultra-scalable data pipelines handling <b>1B+ records/hour</b>.<br>
        🔹 Expert in <b>Apache Kafka, PySpark, RedPanda, Kubernetes, and GCP</b>.<br>
        🔹 Passionate about <b>Real-time Analytics, Distributed Systems, and Cloud Optimization</b>.<br>
        🔹 Achieved <b><2s latency, 40% cost reductions, and 99.99% uptime</b> in production systems.
      </p>
